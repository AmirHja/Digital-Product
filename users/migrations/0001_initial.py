# Generated by Django 4.2 on 2024-09-14 13:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, upload_to='UsersAvatar/', verbose_name='avatar')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('device_uuid', models.UUIDField(default=uuid.uuid4, editable=False, null=True, unique=True, verbose_name='device uuid')),
                ('last_login', models.DateTimeField(null=True, verbose_name='last login date')),
                ('device_type', models.CharField(choices=[('WEB', 'Web'), ('IOS', 'IOS'), ('AND', 'Android'), ('OTH', 'Other')], default='WEB', max_length=3, verbose_name='device type')),
