...
class Payment(models.Model):
    ...
    class Status(models.TextChoices):
        ...
        TRANSLATIONS = {
            VOID: _('Payment could not be processed'),
            PAID: _('Payment successful'),
            ERROR: _('Payment has encountered an error. Our technical team will check the problem shortly'),
            CANCELLED: _('Payment canceled by user.'),
            REFUNDED: _('This payment has been refunded'),
        }
    ...
    status = models.PositiveSmallIntegerField(_('status'), choices=Status.choices, default=Status.VOID, db_index=True)
